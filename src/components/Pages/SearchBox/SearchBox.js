            ...
            <div className="hero-content flex-col lg:flex-row-reverse lg:gap-96 mx-auto text-center">
                <div>
                    ...
                    <div className='max-w-md mx-auto'>
                        <div className="relative flex items-center w-full h-12 rounded-lg transition-all duration-300 ease-in-out focus-within:shadow-lg bg-secondary overflow-hidden border-2 border-secondary">
