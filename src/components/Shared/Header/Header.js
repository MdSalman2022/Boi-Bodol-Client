...
const Header = () => {
    ...
    return (
        <div className={`bg-white w-full h-16 pt-2 sticky top-0 z-50  ${isFixed ? ' rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-80' : ''}`}>
            <div className="container mx-auto grid grid-cols-4 lg:grid-cols-5 ">
                <div className="logo hidden lg:flex">
                    <Link to='/' className=" normal-case text-neutral font-semibold underline decoration-primary">
                        <LazyLoadImage src="https://i.ibb.co/1TxVmL3/boipaben-logo.png" className='w-16' alt="logo" border="0" />
                    </Link>
                </div>
